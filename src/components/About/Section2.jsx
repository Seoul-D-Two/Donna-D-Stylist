...
function Section2() {
  return (
    <div className="container mx-auto py-10">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 p-10 lg:justify-between gap-5 lg:gap-10">
        {/* Contact */}
        ...
        <iframe
          ...
          className="w-full h-full mx-auto md:col-span-2 lg:col-span-1"
        ></iframe>
      </div>
    </div>
  );
