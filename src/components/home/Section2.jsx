...
function Section2() {
  return (
    ...
    <div className="container mx-auto grid gap-10 items-center lg:grid-cols-2 mb-20 md:my-20 lg:px-10">
      <img src={teamImage} alt="Team Image" className="justify-self-center max-w-[40rem] w-full h-auto"/>
      <div className="px-5">
        <h2 className="w-fit border-b border-b-customGrayDark">
          Team Donna D'
        </h2>
        <p className="md:text-xl animate-p mt-5 uppercase">
          Our team is committed to exceptional hairstyling <br /> and personalized
